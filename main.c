    ...
    do
    {
        ...
        switch (menu)
        {
            case 1:
                ...
                scanf("%d %d" "%d" "%d", &dia_entrada[apartamento], &mes_entrada[apartamento], &dia_saida[apartamento], &mes_saida[apartamento]);
            ...
            case 3:
                ...
                printf("Digite a data de entrada(dia e mes) e saida (dia e mes): \n");
                scanf("%d", &dia_entrada);
                scanf("%d", &mes_entrada);
                scanf( "%d", &dia_saida);
                scanf("%d", &mes_saida);
